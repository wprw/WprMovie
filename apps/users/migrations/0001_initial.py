# -*- coding: utf-8 -*-
# Generated by Django 1.11.17 on 2019-06-20 23:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='', max_length=64, verbose_name='昵称')),
                ('birthday', models.DateField(blank=True, null=True, verbose_name='生日')),
                ('gender', models.CharField(choices=[('male', '男'), ('female', '女')], default='female', max_length=8, verbose_name='性别')),
                ('info', models.CharField(default='', max_length=255, verbose_name='个人简介')),
                ...
                ('uuid', models.CharField(default='', max_length=50, verbose_name='唯一标识符')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ip', models.CharField(default='', max_length=64, verbose_name='登录ip')),
                ('add_time', models.DateField(default=datetime.datetime.now, verbose_name='登录时间')),
